...
class MesaNet(nn.Module):
    """
    The layer implementation for [MesaNet: Sequence Modeling by Locally Optimal Test-Time Training].

    Args:
        d_model (int): Hidden size of the input.
        num_heads (int): Number of heads. Default: 16.
        mode (str): Kernel mode. Currently available: `chunk`. Default: `chunk`.
